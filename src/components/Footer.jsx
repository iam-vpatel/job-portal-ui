...
const TERMS_OF_SERVICE_TEXT =
  "By using this job portal you agree to post accurate information, use listings and applicant data only for legitimate hiring purposes, and follow our community guidelines. Accounts that violate these terms may be suspended.";
        ...
        <div className="relative border-t border-gray-700/50 mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              ...
              <Tooltip content={TERMS_OF_SERVICE_TEXT}>
                <a
                  tabIndex={0}
                  className="group relative hover:text-white focus:text-white outline-none transition-colors duration-300"
                >
